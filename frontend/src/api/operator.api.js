...
// Class management
export const createClass = (name, teacher_id, section) =>
  api.post('/operator/classes', { name, teacher_id, section });
...
export const assignTeacher = (classId, teacher_id, subject) =>
  api.put(`/operator/classes/${classId}/teacher`, { teacher_id, subject });
